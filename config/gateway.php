...
return [
    ...
    //--------------------------------
    'zarinpal' => [
        'merchant-id'  => env('ZARINPAL_MERCHANT_ID'),
        'type'         => env('ZARINPAL_TYPE'),             // Types: [zarin-gate || normal]
        'callback-url' => env('ZARINPAL_CALLBACK_URL'),
        'server'       => env('ZARINPAL_SERVER'),                // Servers: [germany || iran || test]
        'email'        => env('ZARINPAL_EMAIL'),
        'mobile'       => env('ZARINPAL_MOBILE'),
